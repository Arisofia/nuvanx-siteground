...
echo "==================================="
./vendor/bin/phpcs --standard=phpcs.xml.dist --report=summary --report-file=phpcs-report.txt
...
echo "==================================="
./vendor/bin/phpstan analyse --configuration=phpstan.neon --error-format=table --no-progress --memory-limit=512M
