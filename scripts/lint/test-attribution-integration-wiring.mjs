...
assert.match(integration, /function nvx_attribution_collector_config\(/);
assert.match(integration, /ssvvuuysgxyqvmovrlvk\.supabase\.co/);
assert.match(integration, /\/functions\/v1\/google-click-attribution/);
