...
/** @return string[] Thank-you page slugs. */
...
/** @return string[] Valoración form page slugs. */
...
function nvx_theme_is_page_slug_in( array $slugs ): bool {
	...
	return '' !== $slug && array() !== $slugs && in_array( $slug, $slugs, true );
}
...
function nvx_theme_hero_blackout_enabled(): bool {
	$enabled = defined( 'NVX_HERO_BLACKOUT' ) ? (bool) NVX_HERO_BLACKOUT : true;
...
/** Configure the main blog index query. */
...
/** Render the blog index shortcode markup. */
