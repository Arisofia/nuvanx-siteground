...
function nvx_btl_detail_registry(): array {
	...
	return array(
		'exion-face'       => array(
			...
			'h1'           => __( 'EXION® Face en Madrid: regeneración endógena facial sin daño térmico agresivo', 'nuvanx-medical' ),
			'lead'         => __( 'Radiofrecuencia monopolar y ultrasonido terapéutico (TUS) a microtemperaturas controladas para redensificar, hidratar y mejorar calidad de piel — con criterio médico en Chamberí y Goya.', 'nuvanx-medical' ),
