...
$wa_from_phone  = static function ( string $e164 ): string {
	$digits = preg_replace( '/\D+/', '', $e164 );
	return 'https://wa.me/' . ( is_string( $digits ) ? $digits : '' );
};
$chamberi_wa = $wa_from_phone( $chamberi_phone );
$goya_wa     = $wa_from_phone( $goya_phone );
	...
	<section class="nvx-section nvx-section--contact-hero" aria-labelledby="nvx-contact-h1">
		<div class="nvx-container">
			...
			<div class="nvx-cta-group">
				...
				<a href="<?php echo esc_url( $chamberi_wa ); ?>"
				...
				<article class="nvx-clinic-card" itemscope itemtype="https://schema.org/MedicalClinic">
					...
					<ul class="nvx-clinic-card__data" role="list">
						...
						<li>
							...
							· <a href="<?php echo esc_url( $chamberi_wa ); ?>" rel="noopener noreferrer" target="_blank">WhatsApp</a>
						</li>
						<li>
				...
				<article class="nvx-clinic-card" itemscope itemtype="https://schema.org/MedicalClinic">
					...
					<ul class="nvx-clinic-card__data" role="list">
						...
						<li>
							...
							· <a href="<?php echo esc_url( $goya_wa ); ?>" rel="noopener noreferrer" target="_blank">WhatsApp</a>
						</li>
						<li>
							<svg class="nvx-icon" aria-hidden="true" width="16" height="16"><use href="#icon-clock"/></svg>
