...
def generate_dossier():
    # Load the consolidated tables
    df_serp = pd.read_csv("/home/ubuntu/nuvanx_audit_2026-08-04/tabla_serp.csv")
    df_gsc = pd.read_csv("/home/ubuntu/nuvanx_audit_2026-08-04/tabla_gsc.csv")
    df_meta = pd.read_csv("/home/ubuntu/nuvanx_audit_2026-08-04/tabla_meta_competencia.csv")
    df_local = pd.read_csv("/home/ubuntu/nuvanx_audit_2026-08-04/tabla_local_doctoralia.csv")
    df_gap = pd.read_csv("/home/ubuntu/nuvanx_audit_2026-08-04/tabla_gap_final.csv")

    # Convert DataFrames to Markdown strings
    serp_markdown = df_serp.to_markdown(index=False)
    gsc_markdown = df_gsc.to_markdown(index=False)
    meta_markdown = df_meta.to_markdown(index=False)
    local_markdown = df_local.to_markdown(index=False)
    gap_markdown = df_gap.to_markdown(index=False)
...
"""
    ...
    with open("/home/ubuntu/nuvanx_audit_2026-08-04/nuvanx_master_audit_dossier.md", "w") as f:
        f.write(dossier_content)
    print("Dossier Maestro Final generado correctamente.")
