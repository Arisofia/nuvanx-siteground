...
function nvx_strategy_solutions_markup(): string {
	...
	$html .= '<section class="nvx-brand-section"><h2>Rostro y cuello</h2>';
	...
	$html .= '<section class="nvx-brand-section"><h2>Contorno corporal</h2>';
	...
	$html .= '<section class="nvx-brand-section"><h2>Calidad y superficie cutánea</h2>';
	...
	$html .= '<section class="nvx-brand-section"><h2>Cambios posgestacionales</h2>';
	...
	$html .= '<section class="nvx-brand-section"><h2>Medicina estética masculina</h2>';
...
function nvx_strategy_why_nuvanx_markup(): string {
	...
	$html .= '<section class="nvx-brand-section nvx-strategy-checklist nvx-strategy-checklist--no"><h2>Lo que no hacemos</h2><ul class="nvx-check-list nvx-check-list--no">';
	...
	$html .= '<section class="nvx-brand-section"><h2>Trazabilidad de productos</h2>';
	...
	$html .= '<section class="nvx-brand-section"><h2>Privacidad durante la atención</h2>';
	...
	$html .= '<section class="nvx-brand-section"><h2>Por qué importa</h2>';
	...
	$html .= '<section class="nvx-brand-section"><h2>Atención en centros sanitarios autorizados</h2>';
...
function nvx_strategy_investment_markup(): string {
	...
	$html .= '<section class="nvx-brand-section"><h2>Cómo leer estas tarifas</h2>';
	...
	$html .= '<section class="nvx-brand-section"><h2>Qué incluye siempre el plan en NUVANX</h2><ul class="nvx-check-list">';
	...
	$html .= '<section class="nvx-brand-section nvx-strategy-checklist nvx-strategy-checklist--no"><h2>Qué no encontrarás aquí</h2><ul class="nvx-check-list nvx-check-list--no">';
	...
	$html .= '<p><a class="nvx-button" href="' . $valuation_url . '">Solicitar valoración médica</a></p></section>';
	$html .= '</article>';
	return $html;
}
