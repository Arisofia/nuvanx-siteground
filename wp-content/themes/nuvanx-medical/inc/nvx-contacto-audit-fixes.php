...
function nvx_contacto_audit_visible_copy( string $content ): string {
	...
	$patterns = array(
		...
		'/Para diagnóstico y plan de tratamiento[^.<]{0,200}\.\s*Esta página es el directorio NAP[^.<]{0,120}\./u'
			=> 'Contacta por teléfono o WhatsApp para solicitar una valoración médica en Chamberí o Salamanca–Goya. El Dr. Rivera o un miembro de su equipo te contactará en un plazo máximo de 24 horas para confirmar tu fecha de valoración.',
