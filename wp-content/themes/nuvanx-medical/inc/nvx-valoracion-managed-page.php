...
function nvx_valoracion_managed_page_markup(): string {
	...
	$html .= function_exists( 'nvx_clinical_authority_byline_markup' )
		...
		: '';
	$html .= '<p class="nvx-brand-hero__lead" id="nvx-valoracion-lead">' . esc_html__( 'Valoración médica en Madrid de 15 a 30 minutos: diagnóstico, indicación y presupuesto documentado antes de tratar. Sin Anestesia General. Recuperación en 48h según el protocolo indicado. Sin obligación de procedimiento.', 'nuvanx-medical' ) . '</p>';
	...
	$html .= '<li>' . esc_html__( 'Recuperación en 48h', 'nuvanx-medical' ) . '</li>';
	$html .= '</ul>';
	$html .= '</div></div></section>';
...
function nvx_valoracion_schema_graph( $graph ) {
	...
	$description = __( 'Valoración médica en Madrid de 15 a 30 minutos: diagnóstico, indicación y presupuesto documentado antes de tratar. Sin Anestesia General. Recuperación en 48h según el protocolo indicado. Sin obligación de procedimiento.', 'nuvanx-medical' );
	$action      = array(
		'@type'  => 'ReserveAction',
