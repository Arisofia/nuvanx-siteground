...
<body <?php body_class(); ?>>
<a class="nvx-skip-link" href="#nvx-main" tabindex="0"><?php esc_html_e( 'Saltar al contenido principal', 'nuvanx-medical' ); ?></a>
<?php wp_body_open(); ?>
...
<header class="nvx-header" role="banner" id="nvx-header">
	...
	<nav class="nvx-nav" aria-label="Menú principal">
		...
		?>
		<a href="<?php echo esc_url( home_url( '/madrid/valoracion/' ) ); ?>" class="nvx-header__cta nvx-brand-btn nvx-btn--primary nvx-open-valoracion-modal" id="nvx-header-cta" data-nvx-valoracion-modal="1" aria-haspopup="dialog"><?php esc_html_e( 'Solicitar valoración médica', 'nuvanx-medical' ); ?></a>
	</nav>
...
<dialog id="nvx-mobile-nav" class="nvx-mobile-nav" aria-label="Menú móvil">
	...
	?>
	<a href="<?php echo esc_url( home_url( '/madrid/valoracion/' ) ); ?>" class="nvx-brand-btn nvx-btn--primary nvx-open-valoracion-modal" id="nvx-mobile-cta" data-nvx-valoracion-modal="1" aria-haspopup="dialog"><?php esc_html_e( 'Solicitar valoración médica', 'nuvanx-medical' ); ?></a>
