...
function nvx_anatomical_facial_catalog_upper_mid(): array {
	return array(
		'tercio-superior' => nvx_anatomical_entry(
			...
			NVX_KICKER_ROSTRO,
			'Las arrugas de la frente no son el problema, son el síntoma de cómo gesticulas.',
			'Si te molestan esas líneas que se quedan marcadas incluso cuando estás seria, la mejor crema no servirá de nada porque el problema está en el músculo que hay debajo. Estudiamos tu forma de gesticular para relajar la zona sin que pierdas tu expresión natural.',
		...
		'mirada' => nvx_anatomical_entry(
			...
			NVX_KICKER_ROSTRO,
			'Tu mirada no siempre refleja lo cansada que estás; a veces es solo la anatomía.',
			'Tener "cara de cansada" durmiendo ocho horas no se arregla con más sueño ni con correctores mágicos. El problema suele ser cómo la luz incide sobre tus ojos debido a un déficit de soporte óseo o calidad de piel.',
		...
		'tercio-medio' => nvx_anatomical_entry(
			...
			NVX_KICKER_ROSTRO,
			'Rellenar los surcos nasogenianos sin dar soporte a los pómulos es como tapar una grieta sin arreglar los cimientos.',
			'Si te ves la cara caída o los surcos muy marcados, la tentación es rellenar la arruga directamente. Pero esa arruga suele formarse porque el pómulo y la mejilla han perdido soporte y la piel "cae".',
...
function nvx_anatomical_facial_catalog_lower(): array {
	return array(
		'labios' => nvx_anatomical_entry(
			...
			NVX_KICKER_ROSTRO,
			'Un labio bonito no es el que más resalta, es el que mejor encaja en tus proporciones.',
			'Huimos de los volúmenes exagerados y los perfiles plásticos. Nuestro objetivo es hidratar, corregir asimetrías o recuperar la estructura que los labios pierden con el tiempo.',
		...
		'tercio-inferior' => nvx_anatomical_entry(
			...
			NVX_KICKER_ROSTRO,
			'A veces no hay papada real: lo que pasa es que el mentón es pequeño y la piel cuelga por falta de soporte.',
...
function nvx_anatomical_body_catalog(): array {
	return array(
		'abdomen-y-flancos' => nvx_anatomical_entry(
			...
			NVX_KICKER_CUERPO,
			'El abdomen no se arregla haciendo abdominales a ciegas. Medimos qué falla antes de actuar.',
			'La "tripita" rebelde que no se va con dieta puede ser grasa localizada, puede ser piel estirada tras fluctuaciones de peso, o puede ser una pared muscular débil. Tratar todo como si fuera grasa es perder el tiempo.',
		...
		'brazos-y-espalda' => nvx_anatomical_entry(
			...
			NVX_KICKER_CUERPO,
			'La piel de los brazos delata la pérdida de colágeno, pero podemos forzar su creación.',
		...
		'tren-inferior' => nvx_anatomical_entry(
			...
			NVX_KICKER_CUERPO,
			'No existe una sola "celulitis". Tratamos la fibrosis, la retención y la grasa de forma independiente.',
