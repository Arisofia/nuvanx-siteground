...
function nvx_profhilo_editorial_body_markup(): string {
	...
	// A. Qué es
	$html .= nvx_page_brand_section_open_markup( 'nvx-profhilo-what', 'nvx-profhilo-what-title' );
	$html .= nvx_page_brand_section_heading_markup( esc_html( $data['what']['kicker'] ?? '' ), 'nvx-profhilo-what-title', esc_html( $data['what']['title'] ?? '' ) );
	...
	$html .= nvx_page_brand_section_open_markup( 'nvx-profhilo-diagnosis', 'nvx-profhilo-diagnosis-title', 'nvx-profhilo-diagnosis__grid' );
	$html .= '<div class="nvx-profhilo-diagnosis__copy">';
	$html .= nvx_page_brand_section_heading_markup( esc_html( $data['diagnosis']['kicker'] ?? '' ), 'nvx-profhilo-diagnosis-title', esc_html( $data['diagnosis']['title'] ?? '' ) );
	...
	// C. Comparativa vs rellenos
	$html .= nvx_page_brand_section_open_markup( 'nvx-profhilo-compare', 'nvx-profhilo-compare-title' );
	$html .= nvx_page_brand_section_heading_markup( esc_html( $data['compare']['kicker'] ?? '' ), 'nvx-profhilo-compare-title', esc_html( $data['compare']['title'] ?? '' ) );
	$html .= '<div class="nvx-profhilo-compare-wrap">';
	$html .= '<table class="nvx-profhilo-compare-table">';
	$html .= '<thead><tr>';
	$html .= '<th scope="col">' . esc_html( $data['compare']['col_param'] ?? '' ) . '</th>';
	$html .= '<th scope="col">' . esc_html( $data['compare']['col_profhilo'] ?? '' ) . '</th>';
	$html .= '<th scope="col">' . esc_html( $data['compare']['col_filler'] ?? '' ) . '</th>';
	$html .= '</tr></thead><tbody>';
	foreach ( $data['compare']['rows'] ?? array() as $row ) {
		$html .= '<tr>';
		$html .= '<th scope="row">' . esc_html( $row['param'] ?? '' ) . '</th>';
		$html .= '<td>' . esc_html( $row['profhilo'] ?? '' ) . '</td>';
		$html .= '<td>' . esc_html( $row['filler'] ?? '' ) . '</td>';
		$html .= '</tr>';
	}
	$html .= '</tbody></table></div></div></section>';

	// D. Biofísica
	$html .= nvx_page_brand_section_open_markup( 'nvx-profhilo-biophysics', 'nvx-profhilo-bio-title' );
	$html .= nvx_page_brand_section_heading_markup( esc_html( $data['biophysics']['kicker'] ?? '' ), 'nvx-profhilo-bio-title', esc_html( $data['biophysics']['title'] ?? '' ) );
	...
	// E. Proceso clínico
	$html .= nvx_page_brand_section_open_markup( 'nvx-profhilo-process', 'nvx-profhilo-process-title' );
	$html .= nvx_page_brand_section_heading_markup( esc_html( $data['process']['kicker'] ?? '' ), 'nvx-profhilo-process-title', esc_html( $data['process']['title'] ?? '' ) );
	$html .= '<p class="nvx-body nvx-body--measure">' . esc_html( $data['process']['body'] ?? '' ) . '</p>';
	$html .= '<div class="nvx-profhilo-process-grid">';

	$step_idx = 0;
	foreach ( $data['process']['steps'] ?? array() as $step ) {
		$sid   = 'nvx-profhilo-step-' . $step_idx;
		$html .= '<article class="nvx-profhilo-step" aria-labelledby="' . esc_attr( $sid ) . '">';
		$html .= nvx_profhilo_process_icon( $step['icon'] ?? 'assess' );
		$html .= '<span class="nvx-profhilo-step__n">' . esc_html( $step['n'] ?? '' ) . '</span>';
		$html .= '<h3 id="' . esc_attr( $sid ) . '" class="nvx-profhilo-step__title">' . esc_html( $step['title'] ?? '' ) . '</h3>';
	...
	$html .= nvx_page_brand_section_open_markup( 'nvx-profhilo-postop', 'nvx-profhilo-postop-title', '', array( 'id' => 'postoperatorio-profhilo' ) );
	$html .= nvx_page_brand_section_heading_markup( esc_html( $data['postop']['kicker'] ?? '' ), 'nvx-profhilo-postop-title', esc_html( $data['postop']['title'] ?? '' ) );
	$html .= '<p class="nvx-body nvx-body--measure">' . esc_html( $data['postop']['body'] ?? '' ) . '</p>';

	$html .= '<ul class="nvx-profhilo-postop-list" role="list">';
	...
	$html .= nvx_page_brand_section_open_markup( 'nvx-profhilo-investment', 'nvx-profhilo-price-title', '', array( 'id' => 'inversion-profhilo' ) );
	$html .= nvx_page_brand_section_heading_markup( esc_html( $data['investment']['kicker'] ?? '' ), 'nvx-profhilo-price-title', esc_html( $data['investment']['title'] ?? '' ) );
	$html .= '<p class="nvx-body nvx-body--measure">' . esc_html( $data['investment']['body'] ?? '' ) . '</p>';
	$html .= '<ul class="nvx-profhilo-price-includes" role="list">';
	...
	// H. FAQ
	$html .= nvx_page_brand_section_open_markup( 'nvx-profhilo-faq', 'nvx-profhilo-faq-title' );
	$html .= nvx_page_brand_section_heading_markup( esc_html( $data['faq']['kicker'] ?? '' ), 'nvx-profhilo-faq-title', esc_html( $data['faq']['title'] ?? '' ) );
	$html .= '<div class="nvx-faq nvx-profhilo-faq-list">';
