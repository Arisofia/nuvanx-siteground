 ...
 *
 * Canonical library used by editorial validation and content-normalization
 * tooling in both Staging and Production release payloads.
 *
 * @package NVX\Shared
 */
...
class NVX_Editorial_Rules {
    ...
    public const ADVISORY_WINDOW_SIZE = 220;
    public const ADVISORY_NEGATION_MAX_LENGTH = 50;
    public const ADVISORY_WARNING_MAX_LENGTH = 40;
    public const ADVISORY_WARNING_SUFFIX_LENGTH = 30;
    public const ADVISORY_CLAUSE_SEPARATORS = '[^.!?,;]';
    public const ADVISORY_SENTENCE_BOUNDARY = '[^.!?,;]';
